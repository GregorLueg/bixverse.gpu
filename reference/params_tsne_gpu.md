...
- lr:
  ...
  Numeric or `NULL`. Learning rate. If `NULL` (the default), the Rust
...
- late_exag_factor:
  ...
  Numeric or `NULL`. If you wish to also use late exaggerations. Can be
  useful on large data sets (set it to `2.0` to `4.0`). Defaults to
  `NULL`.
...
- lr - Numeric or `NULL`. Learning rate. If `NULL` (the default), the
...
- late_exag_factor - Numeric or `NULL`. If you wish to also use late
  exaggerations. Can be useful on large data sets (set it to `2.0` to
