...
[`bixverse::rs_nmf_consensus_mc()`](https://gregorlueg.github.io/bixverse/reference/rs_nmf_consensus_mc.html).
...
`n_dropped` and `n_empty_clusters`. The errors are relative to the
