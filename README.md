...
wgpu runs on your respective system. Previously, the CPU-based versions of
neural net acceleration where running through ndarray and accelerated via
...
terms of compiling everything to make this work, but I cannot guarantee proper 
behaviour here due to the dependency with h5 (for reading in h5ad files). If you
know how to make this work without several hacks in an easy way, please contact
me!
