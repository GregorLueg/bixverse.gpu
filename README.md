...
Currently, the main focus was on acceleration of kNN graph generation, which
is quite ubiquitous in single cell. Other areas of (personal) interest could
be GPU-accelerated k-means (Harmony could benefit here) or specific sparse
matrix multiplications on the GPU for large data sets.  